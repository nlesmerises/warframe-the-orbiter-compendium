    ...
    function injectStyle() {
        ...
        var css =
            ...
            ICONS + "{position:relative!important;display:inline-flex!important;align-items:center!important;" +
                ...
                // issue as the Site Map glyph above, different axis). Nudging the whole button
                // (as before) moved the box itself out of alignment with every other quick-nav
                // icon's box -- so the shift is applied only to an inner wrapper span around the
                // glyph (see QUICK_NAV build below), leaving the button's own position untouched.
